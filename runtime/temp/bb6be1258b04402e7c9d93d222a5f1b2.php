<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:61:"D:\WWW\shawn\public/../application/admin\view\user\index.html";i:1489310892;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <style type="text/css">
        @media screen and  (min-width:768px){
            ...
            .btn-group1{display: block;}
        }
        @media screen and (max-width:768px){
            .btn-group{display: block;}
            .btn-group1{display: none;}
        }
        .ibox-content .form-group{
            width:auto;
        }
        .ibox-content .form-group .btn{
            margin-top:5px;
        }
    </style>
</head>
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <div class="form-group clearfix col-sm-1">
                <a href="./userAdd"><button class="btn btn-primary" type="button"><i class="fa fa-plus"></i>&nbsp;添加用户</button></a>
            </div>
            <!--搜索框开始-->
